  ...
  <div class="hk-pg-wrapper"  style="">
    <div class="container-fluid">
      ...
      <div class="row gy-bvc nn-mb">
        <div class="col-md-12">
          <div class="row lk-kl">
            <div class=""> <a href="addJournalEntry.php">
	...
	?>
              <tr class="uyt hgte" style="background: #e0f5e0;font-size: 12px !important;border-bottom: 1px solid #ccc;">
                ...
                <td><a style="color:#0000FF; " href="#" data-toggle="modal" data-target="#modalpop" onClick="opmodalpop('Narration','modelpop.php?action=showJournalNarration&ndetail=<?php echo htmlentities($resultList->Narration); ?>','100%','auto');"><?php echo $resultList->Narration; ?></a></td>
                <td>-</td>
                <td>-</td>
                <td>-</td>
              ...
              <?php
			foreach($resultList->ListOfArray as $arrData){
			?>
